...
- Management
  ...
  - [A free and open source web-based Swagger page which works with self-hosted eKupier](https://ankur-paan.github.io/ekuiper-manager/)) for testing/building APIs.
