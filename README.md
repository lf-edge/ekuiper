...
- Management
  ...
  - [A free and open source web-based Swagger page which works with self-hosted eKuiper](https://ankur-paan.github.io/ekuiper-manager/)) for testing/building APIs.
