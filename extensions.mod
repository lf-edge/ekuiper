...
require (
	...
	github.com/lf-edge/ekuiper/extensions v0.0.0-20220425035204-e059190dab55
...
require (
	...
	github.com/influxdata/influxdb-client-go/v2 v2.10.1-0.20220921115158-388612e0a5d9 // indirect
