...
func TestCollectionRow(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			value:    []string{"a", "b", "c"},
			wildcard: []string{""},
			result:   []interface{}{4, "b1", 3, Message{"a": 1, "b": "2"}},
		}, {
			...
			result:   []interface{}{1, 2, "v1", "w2", Message{"a": 2, "b": "v1", "c": "w2"}, Message{"a": 1, "b": "v1"}},
		}, {
			rowC: &JoinTuple{Tuples: []TupleRow{
				&Tuple{Emitter: "src1", Message: Message{"a": 1, "b": "v1"}},
				&Tuple{Emitter: "src2", Message: Message{"a": 2, "c": "w2"}},
			...
			wildcard: []string{"", "src1"},
			result:   []interface{}{4, 2, "v1", "w2", 4, Message{"a": 2, "b": "v1", "c": "w2"}, Message{"a": 1, "b": "v1"}},
		}, {
			...
			value:    []string{"a", "b", "d"},
			wildcard: []string{""},
			result:   []interface{}{4, "v1", 4, Message{"a": 1, "b": "v1"}},
		}, {
			...
			value:    []string{"a", "b", "d"},
			wildcard: []string{""},
			result:   []interface{}{4, "v2", 4, Message{"a": 2, "b": "v1", "c": "w2"}},
		},
	}
