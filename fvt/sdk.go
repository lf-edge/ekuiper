...
func (sdk *SDK) GetRuleScanTableSnapshot(ruleName string) (resp *http.Response, err error) {
	req, err := http.NewRequest(http.MethodGet, sdk.baseUrl.JoinPath("rules", ruleName, "show", "scantables").String(), nil)
	if err != nil {
		fmt.Println(err)
		return
	}
