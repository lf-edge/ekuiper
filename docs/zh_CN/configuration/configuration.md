...
| 配置名          | 类型     | 配置作用                                           |
|--------------|--------|------------------------------------------------------|
| etc          | string | 设置 etc 目录的绝对路径，若未设置，则会使用默认相对路径。     |
| data         | string | 设置 data 目录的绝对路径，若未设置，则会使用默认相对路径。   |
| log          | string | 设置 log 目录的绝对路径，若未设置，则会使用默认相对路径。     |
| plugins      | string | 设置 plugins 目录的绝对路径，若未设置，则会使用默认相对路径。 |
