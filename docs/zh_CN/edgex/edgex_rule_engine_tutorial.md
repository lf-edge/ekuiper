...
关于其它 API，请参考[该文档](../api/restapi/overview.md).
...
- [eKuiper 中使用 Golang 模版 (template) 定制分析结果](../guide/sinks/data_template.md) 分析结果在发送给不同的 sink 之前，可以使用数据模版对结果进行二次处理，参考这篇文章可以获取更多的关于数据模版的使用场景。
