...
| runAsync(deprecated) | bool:false                    | Whether the sink will run asynchronously for better performance. If it is true, the sink result order is not promised.                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| dataField           | string: ""                      | Select the nested value of the dataField.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
