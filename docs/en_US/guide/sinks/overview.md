...
| enable               | bool: true                           | Whether to enable this sink action. If set to false, the rule planner skips this sink and does not create its sink pipeline. At least one sink action in a rule must be enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
