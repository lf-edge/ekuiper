...
| rawCert            | true | Kafka client ssl verified crt original text |
| rawKey             | true | Kafka client ssl verified key original text |
| rawCA              | true | Kafka client ssl verified ca original text |
