...
- A [Go application](https://github.com/emqx/kuiper/blob/master/fvt_scripts/edgex/pub.go) is wrote to send data to ZeroMQ message bus, the data is as following.
